  ...
  return (
    <main className="mx-auto max-w-5xl px-6 pb-8">
      ...
      <footer className="py-16">
        <div className="mx-auto max-w-md border border-[rgba(255,50,50,0.3)] px-5 py-3 text-center font-meta text-[10px] uppercase tracking-[0.15em] text-[var(--text-muted)]">
